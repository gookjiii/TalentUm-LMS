          ...
          (snapshot) => snapshot.docs.fold<List<types.Message>>(
            ...
            (previousValue, doc) {
              try {
                ...
                if (authorId == null || authorId.isEmpty || type == null) {
                  return previousValue;
                }

                // Basic validation for required fields by type
                if (type == 'text' || type == 'system') {
                  if (data['text'] == null) return previousValue;
                } else if (type == 'file' || type == 'image' || type == 'video' || type == 'audio') {
                  if (data['name'] == null || data['uri'] == null || data['size'] == null) {
                    return previousValue;
                  }
                }
                ...
                debugPrint('FirebaseChatCore: Failed to parse message ${doc.id}: $e');
                return previousValue;
              }
            },
          ),
