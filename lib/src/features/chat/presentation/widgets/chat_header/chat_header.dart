...
class _ChatHeaderState extends State<ChatHeader> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.failedToOpenCallRoom),
          ),
        );
      }
    }
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              AppLocalizations.of(context)!.teachersChatHasBeenSuccessfully,
            ),
          ),
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    final isSearching =
        widget.chatController.searchQuery.isNotEmpty || _isMobileSearching;
