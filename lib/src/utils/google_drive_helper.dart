...
class GoogleDriveHelper {
  ...
  static Future<Map<String, String>> getDirectDownloadLink(String fileId) async {
    ...
    try {
      ...
      if (response.statusCode == 302 || response.statusCode == 303) {
        ...
        if (location != null) {
          final nextUrl = location.startsWith('http') ? location : 'https://drive.google.com$location';
          ...
          final finalCookieStr = allCookies.map((c) => c.split(';')[0]).join('; ');

          if (warningResponse.statusCode == 200 && warningResponse.data.toString().contains('confirm=')) {
